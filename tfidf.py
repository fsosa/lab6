...
#(u'talk', ((u'rosalee.fleming@enron.com', 3), 12.056978880153091))
tfidf = sender_tf.join(per_term_idf).map(lambda x:{'sender': x[1][0][0], 'term':x[0], 'tf-idf':x[1][0][1]*x[1][1]}).collect()
